                    ...
                    .addOnCompleteListener { task ->
                        ...
                        when (exc) {
                            ...
                            is FirebaseNetworkException -> {
                                ...
                                Toast.makeText(context, "Error de inicio de sesion: ${exc.message}", Toast.LENGTH_SHORT).show()
                                callback(false)
                            }
                        }
                    }
                    ...
                    .addOnCompleteListener { task ->
                        ...
                        when (exc) {
                            ...
                            is FirebaseAuthUserCollisionException -> {
                                Toast.makeText(context, "Correo en uso", Toast.LENGTH_SHORT).show()
                                callback(false)
                            }
                            is FirebaseAuthInvalidCredentialsException -> {
                                Toast.makeText(context, "Formato de correo incorrecto", Toast.LENGTH_SHORT).show()
                                callback(false)
                            }
                            else -> {
                                Toast.makeText(context, "Error al crear la cuenta:${exc.message}", Toast.LENGTH_SHORT).show()
                                callback(false)
                            }
                        }
                    }
